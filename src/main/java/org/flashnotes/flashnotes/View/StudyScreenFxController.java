...
public class StudyScreenFxController implements homeButtonInterface {
...
//        System.out.println(currentDeck.getCards().size());
    ...
    void goToMatchingGame() {
        try {
            Parent root = FXMLLoader.load(MainRunner.class.getResource("/org/flashnotes/flashnotes/MatchingScreen.fxml"));
